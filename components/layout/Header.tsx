...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 right-0 left-0 z-50 bg-white/95 dark:bg-black/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-full mx-auto px-6 py-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link href="/projects" className="flex items-center gap-2">
              ...
              <span 
                className="text-base font-bold text-black dark:text-white tracking-tight"
