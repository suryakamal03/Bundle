    ...
    <div className="bg-white dark:bg-[#151517] border border-gray-200 dark:border-[#26262a] rounded-lg p-4">
      ...
      {activities.length === 0 ? (
        <div className="text-center py-6">
          ...
          <p className="text-xs text-gray-600 dark:text-[#9a9a9a]">No activity</p>
        </div>
      ) : (
          ...
          {activities.slice(0, 3).map((activity) => {
            ...
            return (
              <div
                ...
                className="flex gap-2.5 cursor-pointer hover:bg-gray-50 dark:hover:bg-[#1c1c1f] p-2 rounded-md transition-colors"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-gray-600 dark:text-[#9a9a9a] mt-1 truncate">
                    {displayProjectName}
                  </p>
                  <p className="text-[10px] text-gray-600 dark:text-[#9a9a9a] mt-0.5">
