  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
          ...
          {(['All', 'To Do', 'In Review'] as FilterStatus[]).map((filter) => (
            <button
              ...
              className={cn(
                ...
                activeFilter === filter
                  ? 'text-gray-900 dark:text-[#eaeaea] border-blue-500 dark:border-white'
                  : 'text-gray-600 dark:text-[#9a9a9a] border-transparent hover:text-gray-900 dark:hover:text-[#eaeaea]'
              )}
            >
              {filter}
              ...
              {filteredTasks.map((task) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <p className="text-sm font-medium text-gray-900 dark:text-[#eaeaea] group-hover:text-gray-700 dark:group-hover:text-white truncate">
                        {task.title}
                      </p>
                    </div>
                    ...
                    <div className="flex items-center">
                      <Badge 
                        ...
                        className="text-xs bg-gray-100 dark:bg-[#1c1c1f] text-gray-700 dark:text-[#9a9a9a] border-gray-300 dark:border-[#26262a]"
                      >
                        {task.status}
                      </Badge>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      {task.assignedToName ? (
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-gray-600 dark:text-[#9a9a9a]">Unassigned</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-1.5">
                      {deadlineInfo ? (
                        <>
                          <Calendar className="w-3.5 h-3.5 text-gray-600 dark:text-[#9a9a9a]" />
                          <span className={cn(
                            "text-xs font-medium",
        ...
        <div className="flex items-center justify-center text-sm text-gray-600 dark:text-[#9a9a9a]">
